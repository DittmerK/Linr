...
public class EnterLineController implements Initializable
{
    ...
    public void initialize(URL arg0, ResourceBundle arg1) {
        try
        {
            AnchorPane sidePanel = FXMLLoader.load(getClass().getResource("/com/dittmer/linr/fxml/sidemenu.fxml"));
    ...
    public void submit()
    {
        ...
        if(actor != null)
        {
            ...
            if(possibleDupes.size() > 0)
            {
                Parent root;
                try {
                    FXMLLoader loader = new FXMLLoader(App.class.getResource("/com/dittmer/linr/fxml/duplicate.fxml"));
